    ...
    <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="kullaniciGiris.aspx">Kullanıcı Giriş</a></li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="kullaniciGiris.apx">Kullanıcı Giriş</a></li>
        ...
        <div class="container">
            <div class="text-center mt-5">
                <h1>Admin Girişi</h1>
                <p class="lead">Admin girişlerini bu sayfadan yapınız.</p>
        ...
        <table class="auto-style1"  align="center">
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Giriş" OnClick="Button1_Click" CssClass="btn btn-danger" style="height: 27px" />
                </td>
            </tr>
        </table>
    </form>
